...
// ✅ 對：完整 URL
const PMSYS_URL = 'https://teisalessys.vercel.app/teisale-prototype';
...
```
https://teisalessys.vercel.app/teisale-prototype
```
...
```
https://teisalessys.vercel.app/teisale-prototype?from=projflow
  &u=<id>
  &email=<email>
  &tutorialDone=<0|1>
```
...
| ProjFlow → PMSYS | `https://teisalessys.vercel.app/teisale-prototype?from=projflow&u=<id>&email=<email>&tutorialDone=<0\|1>` |
| ProjFlow → RTM   | `https://rtm-rtm-app-app.vercel.app/index.html?from=projflow&u=<id>&email=<email>&tutorialDone=<0\|1>` |
| RTM → PMSYS      | `https://teisalessys.vercel.app/teisale-prototype?from=rtm&u=<id>&email=<email>&tutorialDone=<0\|1>` |
