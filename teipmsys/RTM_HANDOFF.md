...
| ProjFlow | `https://pm-system-mauve.vercel.app/schedule` |
...
function flipToPMSYS() {
  ...
  window.location.href =
    `https://kai1978intwtei.github.io/tei-news/teipmsys/?${qs.toString()}`;
}
...
function flipToProjFlow() {
  ...
  window.location.href =
    `https://pm-system-mauve.vercel.app/schedule?${qs.toString()}`;
}
```
...
```html
<link rel="preconnect" href="https://kai1978intwtei.github.io" crossorigin>
...
| 方向 | URL 模板 |
| --- | --- |
| PMSYS → ProjFlow | `https://pm-system-mauve.vercel.app/schedule?from=pmsys&u=<id>&email=<email>&name=<name>&enName=<enName>&tutorialDone=<0\|1>` |
...
| RTM → ProjFlow   | `https://pm-system-mauve.vercel.app/schedule?from=rtm&u=<id>&email=<email>&tutorialDone=<0\|1>` |
